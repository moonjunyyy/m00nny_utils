def count_digits(number) -> int: return len(str(object=number))
...
def bytes_to_human_readable(size:int, precision=2) -> str:
    ...
    Args:
        ...
        precision (int, optional): The number of decimal places to round. Defaults to 2.

    Returns:
        str: The human readable format of the bytes.
    '''

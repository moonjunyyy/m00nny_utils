...
class Log:
    def get_level(self, level:str) -> int:
        ...
        if isinstance(level, str):
            if level.upper() == 'DEBUG':    return logging.DEBUG
            if level.upper() == 'INFO':     return logging.INFO
    ...
    def log     (self, message:str) -> None: self.logger.log     (level=self.level, msg=message)
    def debug   (self, message:str) -> None: self.logger.debug   (msg=message)
    def info    (self, message:str) -> None: self.logger.info    (msg=message)
